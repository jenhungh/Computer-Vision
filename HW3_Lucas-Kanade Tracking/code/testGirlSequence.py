...
for index in range(num_frames-1):
    ...
    # Update and Append the rectangles
    ...
    if index in reported_frames:
        ...
        fig.savefig('../plots/Girl_f' + str(index+1) + '.png', bbox_inches = 'tight', pad_inches = 0)

# Save the rectangle history
results_dir = '../results/'
if not os.path.exists(results_dir):
    os.makedirs(results_dir)
np.save('../results/girlseqrects.npy', np.asarray(rect_history))