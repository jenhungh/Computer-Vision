...
for index in range(frames-1):
    ...
    # Improvement: binary dilation and erosion
    mask = scipy.ndimage.binary_dilation(mask, iterations = 3)
    mask = scipy.ndimage.binary_erosion(mask, iterations = 4)
    ...
    if index in reported_frames:
        ...
        fig.savefig('../plots/Ant_f' + str(index+1) + '.png', bbox_inches = 'tight', pad_inches = 0)