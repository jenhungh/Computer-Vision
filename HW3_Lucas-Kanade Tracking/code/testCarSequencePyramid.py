...
reported_frames = [1, 50, 100, 150, 200]
...
for index in range(0, num_frames-1, 2):
    ...
    p = LucasKanadePyramid(It, It1, rect, threshold, num_iters, 3)
    ...
    if len(rect_history) in reported_frames:
        # Plot frames
        fig = plt.figure()
        ...
        fig.savefig('../plots/CarPyramid_f' + str(index + 1) + '.png', bbox_inches = 'tight', pad_inches = 0)
